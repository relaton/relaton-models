...
same internal layout: `models/` (LutaML definitions), `views/` (LutaML
diagram views), `images/` (rendered PNGs), `grammars/` (RNC implementation
grammars accompanying the models).
