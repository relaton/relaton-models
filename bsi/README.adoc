= Relaton BSI Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-bsi/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-bsi/actions/workflows/make.yml"]
