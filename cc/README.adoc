= Relaton CC Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-cc/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-cc/actions/workflows/make.yml"]
