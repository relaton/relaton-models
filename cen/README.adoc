= Relaton CEN Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-cen/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-cen/actions/workflows/make.yml"]
