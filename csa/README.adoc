= Relaton CSA Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-csa/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-csa/actions/workflows/make.yml"]
