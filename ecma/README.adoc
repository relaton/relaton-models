= Relaton ECMA Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-ecma/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-ecma/actions/workflows/make.yml"]
