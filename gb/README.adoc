= Relaton GB Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-gb/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-gb/actions/workflows/make.yml"]
