= Relaton ISO Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-iso/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-iso/actions/workflows/make.yml"]
