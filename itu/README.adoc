= Relaton ITU Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-itu/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-itu/actions/workflows/make.yml"]
