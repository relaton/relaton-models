= Relaton JIS Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-jis/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-jis/actions/workflows/make.yml"]
