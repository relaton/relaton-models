= Relaton MPFA Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-mpfa/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-mpfa/actions/workflows/make.yml"]
