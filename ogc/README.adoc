= Relaton OGC Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-ogc/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-ogc/actions/workflows/make.yml"]
