= Relaton OMG Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-omg/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-omg/actions/workflows/make.yml"]
