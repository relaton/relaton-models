= Relaton Ribose Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-ribose/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-ribose/actions/workflows/make.yml"]
