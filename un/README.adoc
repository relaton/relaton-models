= Relaton UN Bibliographic Data Model
...
image:https://github.com/relaton/relaton-model-un/workflows/make/badge.svg["Build Status", link="https://github.com/relaton/relaton-model-un/actions/workflows/make.yml"]
